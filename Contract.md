...
As my client, you affirm that you have the _power and ability_ to enter into this contract on behalf of your company or organization. You agree to provide me with everything that I’ll need to complete projects, including text, images, and information, whenever I need it and in the format I ask for. You agree to review my work and provide feedback and approval in a timely manner. **Deadlines work both ways and you’ll also be bound by any dates that we set together. You also agree to stick to the payment schedule terms in this contract.**
...
You are responsible for making any project-related purchases such as themes, photos, or hosting, unless otherwise agreed upon in writing. This is for your own benefit, so that you will continue to have access to – and the license to use – any of those third-party assets long after the project ends.
...
I cannot guarantee that my work will always be error-free and so I can’t be liable to you or any third party for resulting damages, including lost profits, lost savings, or other incidental, consequential, or special damages arising out of the operation of or inability to use the products I provide you with, even if you have advised me of the possibility of such damages.

You agree to be solely responsible for and indemnify me in full from all liabilities and expenses arising out of any claim by a third party that any information, data, copyright work, material, software, hardware, or methodologies provided by you to me for use in performance of the terms of this contract infringes any third party’s intellectual property rights.

**You agree to change all relevant passwords (FTP, website, host, databases, etc.) after I no longer need that access** and that I can’t be held liable for any security breaches resulting from your failure to do so.
...
You guarantee to me that any elements of text, graphics, photos, designs, trademarks, or other assets that you provide me with are either owned by you, or that you have permission to use them, and that such license extends to my use of those elements in your project.
...
Although I may show you the in-development product, I prefer to wait until development is mostly finished to ask you for these revisions, so that you don’t have to spend time reporting issues I already know about.
...
This contract is based heavily on [Contract Killer](http://stuffandnonsense.co.uk/blog/about/contract_killer_the_next_hit/) and the [AIGA Standard Form of Agreement for Design Services](http://www.aiga.org/content.cfm/standard-agreement). (Just giving credit where credit’s due.)
...
This contract shall be interpreted under the laws of the Commonwealth of Virginia. The Parties agree that the location and jurisdiction for any dispute arising under this Agreement shall be brought exclusively in any federal or state court located in Fairfax County, Virginia.
